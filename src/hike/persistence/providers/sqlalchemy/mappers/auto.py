...
class DictAutoSQLAlchemyMapper(ISQLAlchemyMapper):
    ...
    Usage::
        ...
        from hike.persistence.providers.sqlalchemy import DictAutoSQLAlchemyMapper, SQLAlchemyRepository
...
class FlatAutoSQLAlchemyMapper(FlatMapperBase):
    ...
    Usage::
        ...
        from hike.persistence.providers.sqlalchemy import FlatAutoSQLAlchemyMapper, SQLAlchemyRepository
